...
local function handCuffAnimation()
    TriggerServerEvent('InteractSound_SV:PlayOnSource', QBX.PlayerData.metadata.ishandcuffed and 'Cuff' or 'Uncuff', 0.4)
    ...
    TriggerServerEvent('InteractSound_SV:PlayOnSource', 'Cuff', 0.4)
    Wait(3500)
...
RegisterNetEvent('police:client:GetCuffed', function(playerId, isSoftcuff)
    if not QBX.PlayerData.metadata.ishandcuffed then
        ...
        TriggerServerEvent('police:server:SetHandcuffStatus', false)
        ClearPedTasksImmediately(cache.ped)
        TriggerServerEvent('InteractSound_SV:PlayOnSource', 'Uncuff', 0.4)
